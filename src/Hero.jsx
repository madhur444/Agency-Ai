 ...
 initial={{opacity:0,y:20}}
    ...
    <motion.div 
     initial={{opacity:0,y:20}}
        ...
        transition={{duration:0.5,delay:0.7}}
        viewport={{once:true}}
    className='relative'><img src={assets.hero_img} alt=""  className='w-full max-w-6xl'/>
    <img src={assets.bgImage1} alt="" className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden' /></motion.div>
    </div>
  )
}
