...
const Services = () => {
  const servicesData = [
    ...
    },
    {
      ...
      description: "We help you execute your plan and deliver real results.",
      icon: assets.marketing_icon,
    },
    {
      title: "Dance",
      description: "We can help you dance with creativity and expression.",
      icon: assets.content_icon,
    },
    {
      title: "Social Media",
      description:
        "We help you build a strong social media presence and engage your audience.",
